...
/// @nodoc
mixin _$GetCars {
  List<Product> get cars => throw _privateConstructorUsedError;
...
class _$GetCarsImpl implements _GetCars {
  _$GetCarsImpl({final List<Product> cars = const []}) : _cars = cars;

  factory _$GetCarsImpl.fromJson(Map<String, dynamic> json) =>
      _$$GetCarsImplFromJson(json);

  final List<Product> _cars;
  @override
  @JsonKey()
  List<Product> get cars {
...
abstract class _GetCars implements GetCars {
  factory _GetCars({final List<Product> cars}) = _$GetCarsImpl;
